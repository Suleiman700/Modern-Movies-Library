        ...
        return (
            <Wrapper>
                <WrapperLink
                    ...
                    onClick={scrollTo}
                >
                    <Button solid title={`Page ${page + 1} `} icon={`arrow-${Languages.getSelectedLanguageTextAlignOpposite()}`} />
                </WrapperLink>
            </Wrapper>
        );
    }
        ...
        return (
            <Wrapper type="both">
                <WrapperLink
                    ...
                    onClick={scrollTo}
                >
                    <Button solid left title={`Page ${page - 1}`} icon={`arrow-${Languages.getSelectedLanguageTextAlign()}`} />
                </WrapperLink>
                <WrapperLink
                    to={`${process.env.PUBLIC_URL}?page=${page + 1}`}
                    onClick={scrollTo}
