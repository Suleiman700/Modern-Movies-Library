...
const Genre = ({
    ...
    const [option, setOption] = useState({
        ...
        label: Languages.getSelectedLanguageTranslation('popularity'),
    });
    ...
    return (
        <Wrapper>
            <Helmet>
                <title>{`${geral.selected} - ${Languages.getSelectedLanguageTranslation('movies')}`}</title>
            </Helmet>
            <Header title={geral.selected} subtitle={Languages.getSelectedLanguageTranslation('movies')} />
