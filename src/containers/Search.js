...
const Search = ({
    ...
    // Else show the results
        ...
        return (
            <Wrapper>
                <Helmet>
                    <title>{`${query} - ${Languages.getSelectedLanguageTranslation('search_results')}`}</title>
                </Helmet>
                <Header title={query} subtitle={Languages.getSelectedLanguageTranslation('search_results')}/>
