...
const Info = styled.div`
  ...
  font-size: 1.3rem;
  direction: ${Languages.getSelectedLanguageTextDirection()};
`;
...
const Text = styled.p`
  ...
  font-weight: 500;
  margin-bottom: 3rem;
  text-align: ${Languages.getSelectedLanguageTextAlign()};
`;
                ...
                <MovieWrapper>
                    ...
                    <MovieDetails>
                        ...
                        <Text>
                            {movie.overview
                                ? movie.overview
                                : Languages.getSelectedLanguageTranslation('there_is_no_synopsis_available') + '...'}
                        </Text>
...
function renderInfo(languages, time, data) {
    ...
    return info
        .filter((el) => el !== null)
        .map((el) => (typeof el === 'number' ? `${el} ${Languages.getSelectedLanguageTranslation('minutes')} ` : el))
